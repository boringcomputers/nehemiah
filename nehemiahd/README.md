...
| `NEHEMIAH_ANTHROPIC_KEY`                 | _(unset)_                        | powers the agents + the gateway's Claude path                                                                                   |
| `NEHEMIAH_OPENROUTER_KEY`                | _(unset)_                        | powers the gateway's non-Claude models                                                                                          |
...
| `NEHEMIAH_S3_ENDPOINT`                   | _(unset)_                        | S3 host:port for volumes (MinIO/Latitude); unset disables storage                                                               |
