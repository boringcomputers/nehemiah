...
| Admitted machine-create success | Creates accepted for placement that reach initial `running`/ready or a documented customer-attributable terminal result ÷ admitted creates | 99.0% platform success | Rolling 30 days, also reported daily |
