...
export const aggregateUsage = async (database, through = new Date()) => {
    await database.query(`INSERT INTO usage_daily
		 ...
		 DO UPDATE SET quantity = EXCLUDED.quantity, refreshed_at = now()`, [through]);
};
//# sourceMappingURL=aggregate-usage.js.map