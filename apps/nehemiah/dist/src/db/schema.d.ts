export declare const machineStates: readonly ["requested", "placing", "starting", "running", "stopping", "stopped", "failed", "lost"];
export type MachineState = (typeof machineStates)[number];
export declare const hostStates: readonly ["ready", "draining", "unhealthy", "stale"];
...
export declare const isMachineState: (value: unknown) => value is MachineState;
